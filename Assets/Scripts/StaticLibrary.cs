...
{
    //°5
    public static string[] circleOfFifths = { "C", "G", "D", "A", "E", "B", "Gb/F#", "Db/C#", "Ab/G#", "Eb/D#", "Bb/A#", "F" };
    public static string[] intervalsList = { "P1", "m2", "M2", "m3", "M3", "P4", "A4/d5", "P5", "m6", "M6", "m7", "M7", "P8" };
    public static string[] notesInOrder = new string[] { "C", "Db/C#", "D", "Eb/D#", "E", "F", "Gb/F#", "G", "Ab/G#", "A", "Bb/A#", "B" };
